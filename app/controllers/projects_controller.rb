...
class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :start_date, :end_date, :plinks, :build_one, :build_two, :build_three, :build_four, :build_five, :build_six, :build_seven, :build_eight, :build_nine, :build_ten, :build_eleven, :build_twelve, :build_thirteen, :build_fourteen, :build_fifthteen, :user_id)
    end
